...
export default function AppRouter() {
  ...
  return (
    ...
    <Routes>
      ...
      <Route path="/faq" element={<ProtectedRoute title="FAQ 管理"><FAQManage /></ProtectedRoute>} />
      ...
      <Route path="/quiz-bank" element={<ProtectedRoute title="题库审核"><QuizBank /></ProtectedRoute>} />
